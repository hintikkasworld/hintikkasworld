...
\begin{itemize}
	...
	\item $\chi_a(\vec y, \vec y') \land \lbigand_{i=1..n} [x_i \lequiv \phi_i(\vec x := \vec y)] \land \lbigand_{i=1..n} [x_i' \lequiv \phi_i(\vec x := \vec y')]$ for all agents $a$.
\end{itemize}
...
\begin{itemize}
	...
	\item Can we sample valuations of a QBF formula?
	\item Touist handles QBF, right?
\end{itemize}
	\end{minipage}}
