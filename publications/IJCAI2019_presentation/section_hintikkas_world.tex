...
\newcommand{\enfantpropregd}{\begin{tikzpicture}[scale=0.3]
	\draw[fill=yellow!20] (0, 0) ellipse (1cm and 1cm);
	\draw[fill=blue!20] (0.3, 0.1) ellipse (.25cm and .25cm);
	\draw[fill=black] (0.4, 0.1) ellipse (.15cm and .15cm);
	\draw[red, line width=0.5mm] (0.2,-.3) edge[out=-90, in=180] (0.7, -0.7);
...
\newcommand{\enfantpropredg}{\begin{tikzpicture}[scale=0.3]
	\draw[fill=yellow!20] (0, 0) ellipse (1cm and 1cm);
	\draw[fill=blue!20] (-0.3, 0.1) ellipse (.25cm and .25cm);
	\draw[fill=black] (-0.4, 0.1) ellipse (.15cm and .15cm);
	\draw[red, line width=0.5mm] (-0.2,-.3) edge[out=-90, in=0] (-0.7, -0.7);
...
\pause
\node at (-4, 2) {\includegraphics[height=1cm]{images/HW_example_sally_and_ann.png}};
\node at (4, 2.8) {\includegraphics[height=1cm]{images/HW_example_dining_cryptographers_problem.png}};
\node at (4, -1) {\includegraphics[height=1cm]{images/HW_example_minesweeper.png}};
\node at (-4, -2) {\includegraphics[height=1cm]{images/HW_example_flatland.png}};
\end{tikzpicture}
\end{center}
