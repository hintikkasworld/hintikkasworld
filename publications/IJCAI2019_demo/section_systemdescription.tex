...
The symbolic model checking of DEL is PSPACE-complete. Thus, the use of BDD is critical. That is why, for manipulating the binary decision diagrams, we wrote a wrapup in C of the library CUDD \cite{}, that produces a Web Assembly library.
