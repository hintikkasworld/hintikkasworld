...
describe('ExplicitEpistemicModel', () => {
    ...
    it('Conjunction 1', () => {
        expect(
            m.modelCheck('w', new types.AndFormula([new types.AtomicFormula('ma'), new types.AtomicFormula('mb')])) == true
        ).toBeTruthy();
    });
    it('Conjunction 2', () => {
        expect(
            m.modelCheck('u', new types.AndFormula([new types.AtomicFormula('ma'), new types.AtomicFormula('mb')])) == false
        ).toBeTruthy();
    });
    it('Disjunction 1', () => {
