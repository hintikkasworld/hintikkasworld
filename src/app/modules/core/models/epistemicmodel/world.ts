...
export abstract class World {
   ...
   */
  protected static roundRect(ctx: CanvasRenderingContext2D, x: number, y: number, width: number, height: number, radius, fill, stroke) {
...
static drawCard(context: CanvasRenderingContext2D, card: any) {
