...
compile_wasm () {
		...
		emcc test.c --emrun -O3 -s ALLOW_MEMORY_GROWTH=1 -s WASM=1 -s EXTRA_EXPORTED_RUNTIME_METHODS='["cwrap"]' --shell-file template.html -I ./vendor/cudd/ -L ./vendor/cudd/.libs/ -lm -lcudd "$@"
}
